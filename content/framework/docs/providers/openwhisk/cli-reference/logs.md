...
layout: Doc
gitLink: /docs/providers/openwhisk/cli-reference/logs.md
---
...
- `--startTime` A specific unit in time to start fetching logs from (ie: `2020` or `1469705761`). Here's a list of the supported string formats:
...
2008            # A calendar date part
20W5            # A week date part
20039              # An ordinal date part
...
2008T09         # An hour time part separated by a T
