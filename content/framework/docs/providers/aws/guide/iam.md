...
menuOrder: 12
layout: Doc
gitLink: /docs/providers/aws/guide/iam.md
---
...
That means that `iamRoleStatements` you've defined on the `provider` level won't be applied anymore. Furthermore, you need to provide the corresponding permissions for your Lambdas `logs` and [`stream`](../../events/streams) events.
