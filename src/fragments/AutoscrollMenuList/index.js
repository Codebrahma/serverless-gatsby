...
import { Box, List, ListItem,  Flex, TextWithIcon, P, Heading } from 'serverless-design-system/src'
...
const AutoScrollMenu= ({ ComparisonListData = mock }) => (
  <Box width={[1, 1, 1/3]}>
    <List>
...
const AutoScrollList = ({ ComparisonListData = mock }) => (
  <Box width={[1, 1, 2/3]}>
    {
